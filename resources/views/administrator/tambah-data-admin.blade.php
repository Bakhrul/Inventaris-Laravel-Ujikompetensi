                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah Data Admin
                                    </h4>
                                    <form action="{{ route('create-admin-admin') }}" method="POST" enctype="multipart/form-data" class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Level</label>
                                                    <select name="level" id="categories" class="form-control">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleTextarea1" rows="29" name="alamat"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <button type="submit" class="btn btn-teal mr-2">Tambah Data</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
