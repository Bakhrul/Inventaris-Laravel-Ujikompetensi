                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah Data Jenis
                                    </h4>
                                    <form action="{{ route('create-jenis-admin') }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Nama Jenis</label>
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama Jenis" name="nama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Kode Jenis</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Kode Jenis" name="kode">
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group">
