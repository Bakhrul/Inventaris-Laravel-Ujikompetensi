                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('create-pinjam-admin') }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama Peminjam" name="nama_peminjam" id="txtNumeric">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$time}}" class="form-control" id="exampleInputEmail3"
