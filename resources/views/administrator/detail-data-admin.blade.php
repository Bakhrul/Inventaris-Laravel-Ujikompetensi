            ...
            <div class="main-panel">
                ...
                @if ($errors->any())
                    ...
                    @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Detail Admin
                                            ...
                                            <div class="col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama" name="nama" value="{{$petugas->nama_petugas}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Nomor Induk Pegawai</label>
                                                    <input type="number" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Nomor Induk Pegawai" name="nip" value="{{$petugas->nip}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Username</label>
                                                    <input type="text" class="form-control" id="exampleInputCity1"
                                                        placeholder="Username" name="username" value="{{$petugas->username}}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Alamat</label>
                                                    <textarea class="form-control" id="exampleTextarea1" rows="12" name="alamat" readonly>{{$petugas->alamat}}</textarea>
                                                </div>
                                            </div>
                                        </div>
