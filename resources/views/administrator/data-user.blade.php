              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data User
                    <a href="{{ route('admin-tambah-user') }}"><button class="btn btn-primary float-right mt-1">Tambah Data</button></a>
                  </h4>
                  <table class="table table-striped  dt-responsive table-responsive-md nowrap mt-2" id="myTable">
                    ...
                    @foreach($user as $data)
                      <tr>
                        ...
                        <td class="py-1">
                        <img src="{{ asset('/images/' .$data->gambar_peminjam) }}" style="border-radius:100%; width:50px;height:50px;" alt="image" >
                        </td>
                        <td>
                          {{ $data->nama_peminjam}}
                        </td>
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('admin-user-detail', $data->id_peminjam)}}"><i class="fa fa-reply fa-fw"></i>Show Detail</a>
                            <a class="dropdown-item" href="{{ route ('admin-user-edit', $data->id_peminjam) }}"><i class="fa fa-history fa-fw"></i>Edit Data</a>
                            <a class="dropdown-item" href="{{route('delete-data-user',$data->id_peminjam)}}"><i class="fa fa-history fa-fw"></i>Hapus Data</a>
                          </div>
                        </div>  
                        </td>
                      </tr>
