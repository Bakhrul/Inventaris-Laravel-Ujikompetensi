              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                          ...
                          ?>
                    <a href="{{ route('admin-tambah-admin') }}"><button class="btn btn-primary float-right mt-1">Tambah Data</button></a>
                    <?php
                    }else{
                      echo"";
                    }
                  ...
                  <table class="table table-striped dt-responsive table-responsive-md nowrap mt-2" id="myTable">
                    ...
                    @foreach($admin as $data)
                      <tr>
                        <td class="py-1">
                        <img src="{{ asset('/images/' .$data->gambar_petugas) }}" style="border-radius:100%; width:50px;height:50px;" alt="image" >
                        </td>
                        <td>
                          {{ $data->nama_petugas}}
                        </td>
                        ...
                        <?php
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('admin-admin-detail', $data->id_petugas)}}"><i class="fa fa-reply fa-fw"></i>Show Detail</a>
                            
                            <a class="dropdown-item" href="{{ route ('admin-admin-edit', $data->id_petugas) }}"><i class="fa fa-history fa-fw"></i>Edit Data</a>
                            
                          <a class="dropdown-item" href="{{route('delete-data-admin',$data->id_petugas) }}"><i class="fa fa-history fa-fw"></i>Hapus Data</a>
