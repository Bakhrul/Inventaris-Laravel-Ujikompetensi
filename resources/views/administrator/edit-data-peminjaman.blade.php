                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Ganti Status peminjaman
                                        <a href="{{ route('admin-peminjaman') }}"><button class="btn btn-primary float-right">Kembali</button></a>
                                    </h4>
                                    <form action="{{ route('update-admin-peminjaman',['id'=> $detail_pinjam->id_detail_pinjam]) }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-12">        
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Jumlah Pinjam" name="nama_barang" value="{{$detail_pinjam->InventarisJOIN->nama}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Jumlah Pinjam</label>
                                                    <input type="number" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Jumlah Pinjam" name="jumlah" value="{{$detail_pinjam->jumlah_pinjam}}" readonly>
                                                </div>
                                                
                                                <input type="text" name="id_inventaris" value="{{$detail_pinjam->id_inventaris}}" hidden>
                                            ...
                                            <div class="col-xl-12">
                                                <button type="submit" class="btn btn-teal mr-2">Update Status</button>
                                            </div>
                                            </div>
                                           </div>
