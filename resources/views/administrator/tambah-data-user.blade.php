                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah Data User
                                    </h4>
                                    <form action="{{ route('create-user-admin') }}" method="POST" enctype="multipart/form-data" class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="exampleInputEmail3"
                                                        placeholder="NIP / NIS" name="nip_nis">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleTextarea1" rows="28" name="alamat"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
