                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Data Admin
                                    
                                    </h4>
                                    <form action="{{ route('update-admin-admin',['id'=> $petugas->id_petugas]) }}" method="POST" enctype="multipart/form-data" class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    {{$petugas->gambar_petugas}}
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Nama lengkap</label>
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama" name="nama" value="{{$petugas->nama_petugas}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Nomor Induk Pegawai</label>
                                                    <input type="number" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Nomor Induk Pegawai" name="nip" value="{{$petugas->nip}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Username</label>
                                                    <input type="text" class="form-control" id="exampleInputCity1"
                                                        placeholder="Username" name="username" value="{{$petugas->username}}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleTextarea1" rows="24" name="alamat">{{$petugas->alamat}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
