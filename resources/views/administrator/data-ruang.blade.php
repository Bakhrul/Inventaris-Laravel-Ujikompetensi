        ...
        @if(session()->has('success-add'))
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Ruang 
                    <a href="{{ route('admin-tambah-ruang') }}"><button class="btn btn-primary float-right mt-1">Tambah Data</button></a>
                  </h4>
                      ...
                      <tr>
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('admin-ruang-detail', $data->id_ruang)}}"><i class="fa fa-reply fa-fw"></i>Show Detail</a>
                            <a class="dropdown-item" href="{{ route ('admin-ruang-edit', $data->id_ruang) }}"><i class="fa fa-history fa-fw"></i>Edit Data</a>
                            <a class="dropdown-item" href="{{ route('delete-data-ruang', $data->id_ruang) }}"><i class="fa fa-history fa-fw"></i>Hapus Data</a>
                          </div>
                        </div>  
                        </td>
                      </tr>
