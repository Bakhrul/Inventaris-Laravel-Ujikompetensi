                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Detail Data Operator
                                    </h4>
                                    <form >
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama" name="nama" value="{{$operator->nama_pegawai}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Nomor Induk Pegawai</label>
                                                    <input type="number" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Nomor Induk Pegawai" name="nip" value="{{$operator->nip}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Username</label>
                                                    <input type="text" class="form-control" id="exampleInputCity1"
                                                        placeholder="Username" name="username" value="{{$operator->username}}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Alamat</label>
                                                    <textarea class="form-control" id="exampleTextarea1" rows="12" name="alamat" readonly>{{$operator->alamat}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
