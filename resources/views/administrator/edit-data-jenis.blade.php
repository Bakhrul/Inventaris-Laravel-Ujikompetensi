                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Data Jenis
                                    </h4>
                                    <form action="{{ route('update-jenis-admin',['id'=> $jenis->id_jenis]) }}" method="POST" enctype="multipart/form-data" class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        value="{{$jenis->nama_jenis}}" name="nama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Kode Jenis</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3"
                                                        value="{{$jenis->kode_jenis}}" name="kode">
                                                </div>                                              
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Keterangan</label>
                                                    <textarea class="form-control" id="exampleTextarea1" rows="7" name="keterangan">{{$jenis->keterangan}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
