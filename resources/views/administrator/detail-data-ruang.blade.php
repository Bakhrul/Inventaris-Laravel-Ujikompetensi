        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Detail Data Ruang
                  </h4>
                  <div class="row my-2">
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>Nama Ruang</label>
                        <input type="text" class="form-control" value="{{$ruang->nama_ruang }}" disabled>
                      </div>
                      <div class="form-group">
                        <label>Kode Ruang</label>
                        <input type="text" class="form-control" value="{{$ruang->kode_ruang }}" disabled>
                      </div>
                    </div>
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>Keterangan</label>
                        <textarea class="form-control" rows="6" disabled>{{$ruang->keterangan}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
