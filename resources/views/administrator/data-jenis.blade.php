              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Jenis
                    <a href="{{ route('admin-tambah-jenis') }}"><button class="btn btn-primary float-right mt-1">Tambah Data</button></a>
                  </h4>
                        ...
                        <td>
                          <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{route('admin-jenis-detail', $data->id_jenis)}}"><i class="fa fa-reply fa-fw"></i>Show
                                Detail</a>
                              <a class="dropdown-item" href="{{ route ('admin-jenis-edit', $data->id_jenis) }}"><i
                                  class="fa fa-history fa-fw"></i>Edit Data</a>
                              <a class="dropdown-item" href="{{ route('delete-data-jenis', $data->id_jenis) }}"><i
    ...
    $(document).ready(function () {
      $('#myTable').DataTable({
        ...
        buttons: [
          {
                extend: 'pdfHtml5',
                title: 'Laporan Data Jenis Barang'
            }
        ]
      });
    });
