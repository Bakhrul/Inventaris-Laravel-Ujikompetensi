        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Detail Data Jenis
                  </h4>
                  <div class="row my-2">
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>Nama Jenis</label>
                        <input type="text" class="form-control" value="{{$jenis->nama_jenis }}" disabled>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-xl-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="6" disabled>{{$jenis->keterangan}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
