                ...
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah Data Inventaris
                                    </h4>
                                    <form action="{{ route('create-inventaris-admin') }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Tanggal pendaftaran</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3"
                                                        name="tanggal" value="{{$time}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Kondisi Barang</label>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Kode Inventaris</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3"
                                                        placeholder="Kode Inventaris" name="kode" value="{{$random}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Nama Petugas</label>
                                                    <select name="nama_petugas" id="categories" class="form-control" readonly>    
                                                        <option value="{{Session::get('id_petugas')}}">{{Session::get('nama_petugas')}}</option>
                                                        
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Keterangan</label>
                                                    <textarea class="form-control" name="keterangan" rows="16"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <button type="submit" class="btn btn-teal mr-2">Tambahkan Data</button>
                                            </div>
                                        </div>
                                    </form>
