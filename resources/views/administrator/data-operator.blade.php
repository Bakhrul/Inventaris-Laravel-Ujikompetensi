        ...
        @if(session()->has('success-add'))
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Operator
                    
                    <?php
                            if(Session::get('username') == "administrator"){
                          ?>
                    <a href="{{ route('admin-tambah-operator') }}">      <button class="btn btn-primary float-right mt-1">Tambah Data</button></a>
                          <?php
                          }else{
                            echo"";
                          }
                  ...
                  <table class="table table-striped dt-responsive table-responsive-md nowrap mt-2" id="myTable">
                    <thead>
                      <tr>
                        <th>
                          Gambar
                    ...
                    @foreach($operator as $data)
                      <tr>
                        <td class="py-1">
                        <img src="{{ asset('/images/' .$data->gambar_pegawai) }}" style="border-radius:100%; width:50px;height:50px;" alt="image" >
                        </td>
                        <td>
                          {{ $data->nama_pegawai}}
                        </td>
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('admin-operator-detail', $data->id_pegawai)}}"><i class="fa fa-reply fa-fw"></i>Show Detail</a>
                            <a class="dropdown-item" href="{{ route ('admin-operator-edit', $data->id_pegawai) }}"><i class="fa fa-history fa-fw"></i>Edit Data</a>
                            <a class="dropdown-item" href="{{route('delete-data-operator',$data->id_pegawai) }}"><i class="fa fa-history fa-fw"></i>Hapus Data</a>
                          </div>
                        </div>  
                        <?php
                        }else{
                          ?>
                          <label class="badge badge-danger" style="width:80px;">No Action</label>
                          <?php
                        }
                        ?>
                        </td>
