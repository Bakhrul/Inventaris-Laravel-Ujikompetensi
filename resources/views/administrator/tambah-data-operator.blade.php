                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah Data Operator 
                                    </h4>
                                    <form action="{{ route('create-operator-admin') }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleTextarea1" rows="23" name="alamat"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
