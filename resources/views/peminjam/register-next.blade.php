                ...
                <div class="row w-100">
                    ...
                    <div class="col-lg-6 mx-auto">
                        ...
                        <div class="auth-form-dark text-left p-5">
                            <h4 class="font-weight-light mb-5 text-center">Selamat Datang, Silahkan daftar sesuai dengan profesi anda</h4>
                            <div class=" row">
                                ...
                                <div class="col-xl-6 mb-3">
                                    <a href="{{route('register') }}">
                                        <button class="btn btn-warning p-3 col-xl-12  strong">Halaman Status Siswa&ensp;<i
