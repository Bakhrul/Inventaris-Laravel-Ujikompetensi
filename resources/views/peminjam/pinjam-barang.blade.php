                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('create-pinjam-user') }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1"
                                                        placeholder="Nama barang" name="nama_barang" value="{{$inventaris->nama}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Nama Peminjam</label>
                                                    <input type="text" class="form-control" id="exampleInputName1" value="{{Session::get('nama_peminjam')}}"
                                                        placeholder="Nama Peminjam" name="nama_peminjam" readonly>
                                                </div>
                                                <input type="text" name="id_inventaris" value="{{$inventaris->id_inventaris}}" hidden>
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Nama yang Meminjamkan</label>
                                                    <select name="nama_pegawai" id="categories" class="form-control">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail3" value="{{$time}}"
                                                        name="tanggal_pinjam" readonly>
                                                </div>
                                                <div class="form-group">
