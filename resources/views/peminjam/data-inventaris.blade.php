                  ...
                  <table class="table table-striped dt-responsive nowrap mt-2" id="myTable">
                    ...
                    <tbody>
                      ...
                      <img src="{{ asset('/images/' .$data->image) }}" style=" width:150px;height:100px;" alt="image" >
                        ...
                        if($data->jumlah == 0){
                          ?>
                        <a href="{{ route('user-tambah-pinjam', $data->id_inventaris) }}"><button class="btn btn-info btn-rounded text-white" disabled>Pinjam</button></a>
                        <?php
                        }else{
                          ?>
                          <a href="{{ route('user-tambah-pinjam', $data->id_inventaris) }}"><button class="btn btn-info btn-rounded text-white">Pinjam</button></a>
                          <?php
                        }
                        ?>
                        </td>
                        <td>
                          <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{route('user-inventaris-detail', $data->id_inventaris)}}"><i
