                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('update-operator-peminjaman',['id'=> $detail_pinjam->id_detail_pinjam]) }}" method="POST" enctype="multipart/form-data"
                                        class="form-samples">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-12">        
                                            ...
                                            <div class="col-xl-12">
                                                <button type="submit" class="btn btn-teal mr-2">Update Status Peminjaman</button>
                                            </div>
                                            </div>
                                           </div>
