      ...
      <div class="main-panel">
        ...
        <?php
          ...
          <div class="alert alert-success col-xl-12 text-center" style="letter-spacing:1px;">
            <marquee direction="left" scrollamount="7" align="center">Semua barang sudah dikembalikan atau tidak ada data peminjaman Terima Kasih !!</marquee>
          </div>
          ...
          <?php
            ...
            <marquee direction="left" scrollamount="7" align="center">Total peminjam yang belum mengembalikan barang : {{$row1}} peminjam, Mohon ditindak lanjuti Terima Kasih !!</marquee>
          </div>
          <?php
          }
          ?>
        @if(session()->has('success-status'))
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Peminjaman Aplikasi Inventaris Sarana dan Prasarana
                  </h4>
                    ...
                    @foreach($row as $data)
                      ...
                      <tr>
                        ...
                        if($data->status_peminjaman == "Belum Kembali"){
                          ?>
                        <a href="{{route('operator-peminjaman-edit', $data->id_detail_pinjam)}}"><button type="button" class="btn btn-info btn-rounded btn-fw">Status Pinjam</button></a>
                        <?php
                        }else{
                          ?>
                          <a href="{{route('operator-peminjaman-edit', $data->id_detail_pinjam)}}"><button type="button" class="btn btn-info btn-rounded btn-fw" disabled>Status Pinjam</button></a>
                          <?php
                        }
                        ?>
                        </td>
                        ...
                        <div class="btn-group dropdown">
                          <button type="button" class="btn btn-teal dropdown-toggle text-white btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Manage
                          </button>
                          <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('operator-peminjaman-detail', $data->id_peminjaman)}}"><i
