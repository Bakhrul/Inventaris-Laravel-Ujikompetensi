      ...
      <div class="content-wrapper d-flex align-items-center auth login-full-bg">
        ...
        @if(session()->has('success-regist'))
          ...
          @if ($errors->any())
            ...
            <a href="{{route('index') }}"><button class="btn btn-warning float-right"><i class="fa fa-home"></i>Home</button></a>  
              <h2>Login</h2>
              <h4 class="font-weight-light">Hello! let's get started</h4>
                
              <form class="pt-5" action="{{route('login-proses-operator') }}" method="POST">
              {{ csrf_field() }}
